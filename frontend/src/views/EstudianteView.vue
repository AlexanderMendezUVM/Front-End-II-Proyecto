    ...
    <div class="grilla">
      <div v-for="(materia, index) in materias" :key="index">
        <div class="materia-item">
          ...
          <button class="actividades" @click="veractividad(materia)">Actividades</button>
        </div>
      </div>
    </div>
  </div>
...
const veractividad = ({ _id, idmat }) => {
  console.log("ID MATERIA ESTUDIANTE: ",idmat._id);
  router.push({ name: "listaractividadesest", params:{idmat:idmat._id}});
}
